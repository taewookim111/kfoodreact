            ...
            <section id="news">
                <div className="inner">
                    ...
                    <div className="wrap">
                        <article>
                            <div className="pic">
                                <img src="./img/김치볶음밥.webp" alt="김치볶음밥" />
                                <img src="./img/김치볶음밥.jpg" className="pic2" alt="김치볶음밥" />
                            </div>
                        ...
                        <article>
                            <div className="pic">
                                <img src="./img/나물.jpg" alt="나물" />
                                <img src="./img/나물.png" className="pic2" alt="나물" />
                            </div>
                            <h2>나물 (Namul)</h2>
                        ...
                        <article>
                            <div className="pic">
                                <img src="./img/쌈.webp" alt="쌈" />
                                <img src="./img/쌈.jpg" className="pic2" alt="쌈" />
                            </div>
                            <h2>쌈 (Wrap)</h2>
                        ...
                        <article>
                            <div className="pic">
                                <img src="./img/불고기.webp" alt="불고기" />
                                <img src="./img/불고기.jpg" className="pic2" alt="불고기" />
                            </div>
                            <h2>불고기 (Bulgogi)</h2>
