    ...
    return (
        <>
            <section id="kimchi">
                <div className="inner1">
                    ...
                    <div className="txt">
                        <p>김치가 인정받는 제일 큰 이유는 바로 유산균 때문입니다. 김치의 효력으로는 소화를 증진시키고 피부 질환을 유발하는 균을 억제시키며
                            ...
                            그리고 자극적인 식품 섭취량을 크게 줄인다고 가정했을 때에는 위궤양에도 효과가 좋다고 하는데 이 중 대부분은 풍부한 유산균 덕분입니다. <br /><br />
                            The biggest reason kimchi is recognized is because of its lactic acid bacteria. The effects of kimchi include improving digestion, suppressing bacteria that cause skin diseases, and
                            Cholesterol decomposition (this is a collaboration between lactic acid bacteria and the garlic used in kimchi), prevention of adult diseases and weight loss effects,
                ...
                <div className="banner">
                    ...
                    <div className="inner3">
                        <p>지금의 김치의 가장 큰 아이덴티티인 고춧가루가 들어가게 된 것에는 슬픈 사연이 있습니다.
                            경신대기근이 닥쳤을 때는 산천초목이 죄다 말라버려 소금을 만들기 위한 재료인 땔감의 가격이 치솟았습니다.
                            산과 들의 나무는 소금뿐 아니라 민초의 겨울나기를 위한 장작과 그 외 다른 부수적인 작업에도 사용되어야 했으므로
                            결과적으로는 소금값도 함께 폭등할 수밖에 없었습니다. 이에 사람들이 소금값을 아끼고자 다양한 방법의 대용품을 찾아냈는데
                            그중 하나가 고춧가루였습니다.
                        </p>
                        <p>There is a sad story behind the addition of red pepper powder, which is now the biggest identity of kimchi.
                            When the Great Gyeongsin Famine struck, the mountains and rivers dried up and the price of firewood, an ingredient for making salt, soared.
                            Trees from the mountains and fields had to be used not only for salt, but also for firewood for the common people to survive the winter and other auxiliary work.
                            As a result, the price of salt had no choice but to skyrocket as well. Accordingly, people have found various substitutes to save on the cost of salt.
                            One of them was red pepper powder.
                        </p>
                    </div>
                </div>
            </section>
            <section id="map">
                ...
                <div className="left">
                    ...
                    <p>
                        ...
                        오늘날에도 수원시의 상징이자 랜드마크로, 1997년 12월 유네스코 세계유산에 등재되었습니다. <br /><br />
                ...
                <div className="right">
                    <h2>강원도 (Gangwon-do)</h2>
                    <p>
                        강원도는 담백하고 시원한 맛을 내기 위해
                        멸치를 우린 물을 사용하여 넣거나,
                        감칠맛을 내기 위해 맑은 새우젓, 멸치젓을 사용합니다.<br /><br />
                    ...
                    <p>
                        ...
                        위 사진은 절 끝자락에 위치한 거대한 관음불상으로 1977년까지만 해도 동양 최대의 불상이었습니다.<br /><br />
                ...
                <div className="right1">
                    <h2>경상도 (Gyeongsang-do)</h2>
                    <p>
                        경상도는 맵고 짠맛을 내는 것이 특징입니다.
                        멸치젓 국물과 갈치속젓을 넣어 만들고,
                        국물을 적게 하여 만든다고 합니다. <br /><br />
                    ...
                    <p>
                        ...
                        하회라는 이름 그대로 강물이 마을을 감싸고 흐르고 있습니다. <br /><br />
            ...
            <section id="process">
                <ul className="panel2">
                    <li data-index="1">
                        <h2 className="text">채소 절이기 (Pickling vegetables)</h2>
                        <p className="text1">
                            김장은 우선 김치의 주재료가 되는 채소를 씻어서 소금에 절이는 것부터 시작합니다.
                            소금을 뿌려 둔 채 한나절 정도 두면 채소가 처지는데,
                            이를 "(숨이) 죽는다"라고 표현합니다. <br /><br />
                            Kimchi begins with washing the vegetables, which are the main ingredients of kimchi, and then pickling them in salt.
                            If you leave the vegetables sprinkled with salt for about half a day, they will sag.
                            This is expressed as “(breath) dying.”
                        </p>
                    </li>
                    <li data-index="2">
                        <h2 className="text">양념 하기 (Seasoning)</h2>
                        <p className="text1">
                            이후 큰 통에 젓갈, 고춧가루 등을 이용해
                            김치에 필요한 양념을 만들고, 염장해 둔 채소를 양념에 버무립니다. <br /><br />
                            Afterwards, use salted fish and red pepper powder in a large container.
                            Make the seasoning needed for kimchi and mix the salted vegetables with the seasoning.
                        </p>
                    </li>
                    <li data-index="3">
                        <h2 className="text">보관하기 (Storage)</h2>
                        <p className="text1">
                            이제 잘 보관하면 됩니다. 김치는 찬 곳에서 잘 숙성됩니다. <br /> <br />
                            Now all you have to do is keep it cold. Kimchi ripens well in a cold place.
                        </p>
                    </li>
                </ul>
